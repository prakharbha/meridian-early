...
export function CompassLogo() {
    ...
    return (
        <div className="flex items-center gap-1.5 md:gap-3">
            {/* MERIDIAN text */}
            <span className="text-sm md:text-xl font-light tracking-[0.15em] md:tracking-[0.2em] text-neutral-900">
                MERIDIAN
            </span>
            ...
            >
                {/* Outer ring */}
                <div className="absolute inset-0 rounded-full border border-neutral-300 bg-white/50 md:border-2" />

                {/* Cardinal markers - hidden on mobile */}
                <div className="hidden md:flex absolute inset-0 items-center justify-center">
                    <span className="absolute top-0.5 text-[8px] font-bold text-neutral-900">N</span>
                ...
                >
                    ...
                    {/* Center */}
                    <div className="w-1 h-1 md:w-1.5 md:h-1.5 bg-neutral-900 rounded-full" />
                </div>
            </div>

            {/* COMPASS text */}
            <span className="text-sm md:text-xl font-extralight tracking-[0.15em] md:tracking-[0.2em] text-neutral-500">
                COMPASS
            </span>
        </div>
    );
